...
pub trait ImagesCompatApi {
    fn image_build(&self, content_type: Option<&str>, x_registry_config: Option<&str>, dockerfile: Option<&str>, t: Option<&str>, extrahosts: Option<&str>, remote: Option<&str>, q: Option<bool>, nocache: Option<bool>, cachefrom: Option<&str>, pull: Option<bool>, rm: Option<bool>, forcerm: Option<bool>, memory: Option<i32>, memswap: Option<i32>, cpushares: Option<i32>, cpusetcpus: Option<&str>, cpuperiod: Option<i32>, cpuquota: Option<i32>, buildargs: Option<&str>, shmsize: Option<i32>, squash: Option<bool>, labels: Option<&str>, networkmode: Option<&str>, platform: Option<&str>, target: Option<&str>, outputs: Option<&str>, input_stream: Option<std::path::PathBuf>) -> Pin<Box<dyn Future<Output = Result<models::ImageBuild200Response, Error>>>>;
    fn image_create(&self, x_registry_auth: Option<&str>, from_image: Option<&str>, from_src: Option<&str>, repo: Option<&str>, tag: Option<&str>, message: Option<&str>, platform: Option<&str>, input_image: Option<std::path::PathBuf>) -> Pin<Box<dyn Future<Output = Result<std::path::PathBuf, Error>>>>;
    fn image_delete(&self, name: &str, force: Option<bool>, noprune: Option<bool>) -> Pin<Box<dyn Future<Output = Result<Vec<models::ImageDelete200ResponseInner>, Error>>>>;
    fn image_get(&self, name: &str) -> Pin<Box<dyn Future<Output = Result<std::path::PathBuf, Error>>>>;
    fn image_get_all(&self, names: &str) -> Pin<Box<dyn Future<Output = Result<std::path::PathBuf, Error>>>>;
    fn image_history(&self, name: &str) -> Pin<Box<dyn Future<Output = Result<models::HistoryResponse, Error>>>>;
    fn image_inspect(&self, name: &str) -> Pin<Box<dyn Future<Output = Result<models::ImageInspect, Error>>>>;
    fn image_list(&self, all: Option<bool>, filters: Option<&str>, digests: Option<bool>) -> Pin<Box<dyn Future<Output = Result<Vec<models::Summary>, Error>>>>;
    fn image_load(&self, quiet: Option<bool>, request: Option<&str>) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
    fn image_prune(&self, filters: Option<&str>) -> Pin<Box<dyn Future<Output = Result<Vec<models::ImageDelete200ResponseInner>, Error>>>>;
    fn image_push(&self, name: &str, tag: Option<&str>, all: Option<bool>, compress: Option<bool>, destination: Option<&str>, x_registry_auth: Option<&str>) -> Pin<Box<dyn Future<Output = Result<std::path::PathBuf, Error>>>>;
    fn image_search(&self, term: Option<&str>, limit: Option<i32>, filters: Option<&str>, tls_verify: Option<bool>, list_tags: Option<bool>) -> Pin<Box<dyn Future<Output = Result<models::ImageSearch200Response, Error>>>>;
    fn image_tag(&self, name: &str, repo: Option<&str>, tag: Option<&str>) -> Pin<Box<dyn Future<Output = Result<(), Error>>>>;
}
...
impl<C: Connect>ImagesCompatApi for ImagesCompatApiClient<C>
    ...
    #[allow(unused_mut)]
    fn image_create(&self, x_registry_auth: Option<&str>, from_image: Option<&str>, from_src: Option<&str>, repo: Option<&str>, tag: Option<&str>, message: Option<&str>, platform: Option<&str>, input_image: Option<std::path::PathBuf>) -> Pin<Box<dyn Future<Output = Result<std::path::PathBuf, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::POST, "/images/create".to_string())
        ;
    ...
    #[allow(unused_mut)]
    fn image_delete(&self, name: &str, force: Option<bool>, noprune: Option<bool>) -> Pin<Box<dyn Future<Output = Result<Vec<models::ImageDelete200ResponseInner>, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::DELETE, "/images/{name}".to_string())
        ;
    ...
    #[allow(unused_mut)]
    fn image_get(&self, name: &str) -> Pin<Box<dyn Future<Output = Result<std::path::PathBuf, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/images/{name}/get".to_string())
        ;
        req = req.with_path_param("name".to_string(), name.to_string());
    ...
    #[allow(unused_mut)]
    fn image_get_all(&self, names: &str) -> Pin<Box<dyn Future<Output = Result<std::path::PathBuf, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/images/get".to_string())
        ;
    ...
    #[allow(unused_mut)]
    fn image_history(&self, name: &str) -> Pin<Box<dyn Future<Output = Result<models::HistoryResponse, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/images/{name}/history".to_string())
        ;
        req = req.with_path_param("name".to_string(), name.to_string());
    ...
    #[allow(unused_mut)]
    fn image_inspect(&self, name: &str) -> Pin<Box<dyn Future<Output = Result<models::ImageInspect, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/images/{name}/json".to_string())
        ;
        req = req.with_path_param("name".to_string(), name.to_string());
    ...
    #[allow(unused_mut)]
    fn image_list(&self, all: Option<bool>, filters: Option<&str>, digests: Option<bool>) -> Pin<Box<dyn Future<Output = Result<Vec<models::Summary>, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/images/json".to_string())
        ;
    ...
    #[allow(unused_mut)]
    fn image_load(&self, quiet: Option<bool>, request: Option<&str>) -> Pin<Box<dyn Future<Output = Result<(), Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::POST, "/images/load".to_string())
        ;
    ...
    #[allow(unused_mut)]
    fn image_prune(&self, filters: Option<&str>) -> Pin<Box<dyn Future<Output = Result<Vec<models::ImageDelete200ResponseInner>, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::POST, "/images/prune".to_string())
        ;
        if let Some(ref s) = filters {
            let query_value = s.to_string();
            req = req.with_query_param("filters".to_string(), query_value);
    ...
    #[allow(unused_mut)]
    fn image_push(&self, name: &str, tag: Option<&str>, all: Option<bool>, compress: Option<bool>, destination: Option<&str>, x_registry_auth: Option<&str>) -> Pin<Box<dyn Future<Output = Result<std::path::PathBuf, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::POST, "/images/{name}/push".to_string())
        ;
        if let Some(ref s) = tag {
            let query_value = s.to_string();
            req = req.with_query_param("tag".to_string(), query_value);
    ...
    #[allow(unused_mut)]
    fn image_search(&self, term: Option<&str>, limit: Option<i32>, filters: Option<&str>, tls_verify: Option<bool>, list_tags: Option<bool>) -> Pin<Box<dyn Future<Output = Result<models::ImageSearch200Response, Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::GET, "/images/search".to_string())
        ;
    ...
    #[allow(unused_mut)]
    fn image_tag(&self, name: &str, repo: Option<&str>, tag: Option<&str>) -> Pin<Box<dyn Future<Output = Result<(), Error>>>> {
        let mut req = __internal_request::Request::new(hyper::Method::POST, "/images/{name}/tag".to_string())
        ;
        if let Some(ref s) = repo {
            let query_value = s.to_string();
            req = req.with_query_param("repo".to_string(), query_value);
