...
impl Pods {
    pub fn new(config: Arc<dyn ClientConfig>) -> Pods {
        Pods { config }
    }
    ...
    pub async fn pod_exists_libpod(&self, name: &str) -> Result<(), Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    /// Kill a pod
    pub async fn pod_kill_libpod<'a>(
        &self,
        name: &str,
    ...
    /// List pods
    pub async fn pod_list_libpod<'a>(
        &self,
    ...
    /// Prune unused pods
    pub async fn pod_prune_libpod(&self) -> Result<super::super::models::PodPruneReport, Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    pub async fn pod_stats_all_libpod<'a>(
        &self,
