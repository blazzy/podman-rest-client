...
pub struct ContainersCompat {
    config: Arc<dyn ClientConfig>,
}

impl ContainersCompat {
    pub fn new(config: Arc<dyn ClientConfig>) -> ContainersCompat {
        ContainersCompat { config }
    }

    /// POST /commit
    /// New Image
    /// Create a new image from a container
    pub async fn image_commit<'a>(
        &self,
    ...
    pub async fn container_archive<'a>(
        &self,
        name: &str,
    ...
    pub async fn put_container_archive<'a>(
        &self,
        name: &str,
    ...
    pub async fn container_attach<'a>(
        &self,
        name: &str,
    ...
    pub async fn container_export(&self, name: &str) -> Result<(), Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    ) -> Result<super::super::models::ContainerJson, Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    pub async fn container_pause(&self, name: &str) -> Result<(), Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    pub async fn container_rename<'a>(
        &self,
        name: &str,
    ...
    /// Start a container
    pub async fn container_start<'a>(
        &self,
        name: &str,
    ...
    pub async fn container_unpause(&self, name: &str) -> Result<(), Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    pub async fn container_wait<'a>(
        &self,
        name: &str,
        params: Option<super::super::params::ContainerWait<'a>>,
    ) -> Result<super::super::models::ContainerWaitResponse, Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    /// Create a container
    pub async fn container_create<'a>(
        &self,
        params: Option<super::super::params::ContainerCreate<'a>>,
        body: super::super::models::CreateContainerConfig,
    ...
    ) -> Result<Vec<super::super::models::Container>, Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    pub async fn container_prune<'a>(
        &self,
        params: Option<super::super::params::ContainerPrune<'a>>,
    ) -> Result<Vec<super::super::models::ContainersPruneReport>, Error> {
        let mut request_url = url::Url::parse(self.config.get_base_path())?;
    ...
    pub async fn container_archive_libpod<'a>(
        &self,
        name: &str,
